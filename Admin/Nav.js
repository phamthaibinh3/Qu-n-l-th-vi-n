...
const Nav = () => {
    ...
    return (
        <div className="fixed w-screen bg-primary p-6 top-0" >
            {/* desktop and tablet */}
            <div className="hidden md:flex w-full h-full items-center justify-between">
                <Link to="/trangchuad" className="flex items-center gap-2">
                ...
                <div className="flex items-center gap-8">
                    <ul className="flex items-center gap-8 text-lg">
                        <Link to='/admin/khosach' className=" text-textColor hover:text-headingColor duration-100 transition-all ease-in-out cursor-pointer">
                            Kho sách
                        </Link>
