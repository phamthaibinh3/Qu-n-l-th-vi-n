...
import TaiLieuMoiNhatKH from "./TaiLieuMoiNhatKH";
import TaiLieuXemNhieuNhatKH from "./TaiLieuXemNhieuNhatKH";
import NavKH from "./NavKH";
import Footer from "../Component/Footer";
export default function TrangChuKH() {
  return (
    <div>
      <NavKH/>
