...
const NavKH = () => {
    ...
    return (
        <div className="fixed w-screen bg-lime-300 p-6 top-0" >
            {/* desktop and tablet */}
            <div className="hidden md:flex w-full h-full items-center justify-between">
                <Link to="/trangchukh" className="flex items-center gap-2">
                ...
                <div className="flex items-center gap-8">
                    <ul className="flex items-center gap-8 text-lg">
                        <Link to='/khokh' className=" text-textColor hover:text-headingColor duration-100 transition-all ease-in-out cursor-pointer">
                            Kho sách
                        </Link>
                        ...
                        <Link to='/docgiaadmin' className=" text-textColor hover:text-headingColor duration-100 transition-all ease-in-out cursor-pointer">
                            Độc giả
                        </Link>
                        <Link to='/themnv' className=" text-textColor hover:text-headingColor duration-100 transition-all ease-in-out cursor-pointer">
                            Quản lý nhân viên
                        </Link > */}
